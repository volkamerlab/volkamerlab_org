...
<p>David Mauricio Ramírez Sánchez will talk about two pore domain TASK channels linked to breast cancer, sleep apnea and atrial fibrillation. 
...
<p>Dominique Sydow, a PhD student from the Volkamer Lab, will show how the structural information of kinase pockets can be encoded computationally and used to understand and predict (dis)similarities in this highly conserved protein class. These similarities can guide polypharmacology, off-target, and repurposing studies. Dominique will also shortly promote the TeachOpenCADD platform for everyone who is interested in learning Python programming in the context of cheminformatics and structural bioinformatics.</p>
